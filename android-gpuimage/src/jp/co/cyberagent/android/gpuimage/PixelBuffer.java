...
public class PixelBuffer {
    ...
    public void setRenderer(final GLSurfaceView.Renderer renderer) {
        ...
        if (!Thread.currentThread().getName().equals(mThreadOwner)) {
            if(BuildConfig.DEBUG)Log.e(TAG, "setRenderer: This thread does not own the OpenGL context.");
            return;
        }
    ...
    public Bitmap getBitmap() {
        ...
        if (mRenderer == null) {
            if(BuildConfig.DEBUG)Log.e(TAG, "getBitmap: Renderer was not set.");
            return null;
        }

        // Does this thread own the OpenGL context?
        if (!Thread.currentThread().getName().equals(mThreadOwner)) {
            if(BuildConfig.DEBUG)Log.e(TAG, "getBitmap: This thread does not own the OpenGL context.");
            return null;
        }
    ...
    private void listConfig() {
        if(BuildConfig.DEBUG)Log.i(TAG, "Config List {");
        ...
        for (EGLConfig config : mEGLConfigs) {
            ...
            if(BuildConfig.DEBUG)Log.i(TAG, "    <d,s,r,g,b,a> = <" + d + "," + s + "," +
                    r + "," + g + "," + b + "," + a + ">");
        }
