...
public class ThemeManager {
    ...
    /**
     * Init ThemeManager. Should be call in {@link com.beastbikes.android.BeastBikes#onCreate()}.
    ...
    public static void init(Context context, int totalTheme, int defaultTheme, @Nullable EventDispatcher dispatcher){
        getInstance().setup(context.getApplicationContext(), totalTheme, defaultTheme, dispatcher);
    }
