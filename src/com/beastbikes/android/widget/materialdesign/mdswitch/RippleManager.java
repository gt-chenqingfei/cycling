...
public final class RippleManager implements View.OnClickListener {
    ...
    public void onCreate(View v, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MDRippleView, defStyleAttr, defStyleRes);
        int rippleStyle = a.getResourceId(R.styleable.MDRippleView_rd_rv_style, 0);
        ...
        if (rippleStyle != 0)
            ...
            boolean rippleEnable = a.getBoolean(R.styleable.MDRippleView_rd_rv_enable, false);
            if (rippleEnable)
