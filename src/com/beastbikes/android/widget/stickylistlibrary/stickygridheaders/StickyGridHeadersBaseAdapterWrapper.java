...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    private HeaderFillerView getHeaderFillerView(int headerPosition, View convertView,
        ...
        if (headerFillerView == null) {
            headerFillerView = new HeaderFillerView(mContext, this.mGridView);
        }
     ...
     * @author Tonic Artos
     */
    public static class HeaderFillerView extends FrameLayout {
        ...
        public HeaderFillerView(Context context, StickyGridHeadersGridView mGridView) {
            super(context);
