...
public class SwitchView extends LinearLayout implements Checkable {
    ...
    private boolean open = true; // 开关当前状态
    ...
    private OnClickSwitchListener onClickListener; // 监控开关状态
    ...
    private void init() {
        ...
        maskImage.setImageResource(R.drawable.ic_switch);
        addView(maskImage);
    ...
    private void changeStatus() {
        if (isAninFinish && !isChangedByTouch) {
            ...
            if (onClickListener != null) {
                onClickListener.onSwitchChanged(open);
            }
    ...
    public OnClickSwitchListener getOnClickListener() {
        return onClickListener;
    }

    public void setOnClickSwitchListener(OnClickSwitchListener onClickListener) {
