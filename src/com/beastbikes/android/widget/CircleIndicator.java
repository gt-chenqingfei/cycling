...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorSelectedWidth = -1;
    private int mIndicatorSelectedHeight = -1;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedWidth =
                typedArray.getDimensionPixelSize(R.styleable.CircleIndicator_ci_selected_width, -1);
        mIndicatorSelectedHeight =
                typedArray.getDimensionPixelSize(R.styleable.CircleIndicator_ci_selected_height, -1);
        mIndicatorMargin =
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (mLastPosition >= 0 && (currentIndicator = getChildAt(mLastPosition)) != null) {
                ...
                LayoutParams params = (LinearLayout.LayoutParams) currentIndicator.getLayoutParams();
            ...
            if (selectedIndicator != null) {
                ...
                LayoutParams params = (LinearLayout.LayoutParams) selectedIndicator.getLayoutParams();
    ...
    private void createIndicators() {
        ...
        for (int i = 0; i < count; i++) {
            if (currentItem == i) {
                addIndicator(mIndicatorBackgroundResId, mImmediateAnimatorOut, true);
            } else {
                addIndicator(mIndicatorUnselectedBackgroundResId, mImmediateAnimatorIn, false);
            }
        }
    }
    ...
    private void addIndicator(@DrawableRes int backgroundDrawableId, Animator animator,
        ...
        addView(Indicator, isSelected ? mIndicatorSelectedWidth : mIndicatorWidth,
                isSelected ? mIndicatorSelectedHeight : mIndicatorHeight);
