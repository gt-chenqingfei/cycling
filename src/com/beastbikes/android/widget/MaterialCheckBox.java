...
public class MaterialCheckBox extends View {
    ...
    private void init(Context context) {
        ...
        backgroundColor = getResources().getColor(R.color.red_color);
        doneShapeColor = getResources().getColor(R.color.bg_theme_black_color);
        borderColor = getResources().getColor(R.color.gray);
        ...
        paintCenter.setColor(getResources().getColor(R.color.bg_theme_black_color));
