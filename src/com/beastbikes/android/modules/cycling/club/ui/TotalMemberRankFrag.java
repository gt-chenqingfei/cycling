...
public class TotalMemberRankFrag extends SessionFragment implements PullRefreshListView.onListViewListener {
        ...
        this.getAsyncTaskQueue().add(
                new AsyncTask<Void, Void, List<RankDTO2>>() {
                    ...
                    protected List<RankDTO2> doInBackground(Void... params) {
                        try {
                            return clubManager
                                    .getClubMemberRankList(RankingManager.TOTAL_RANK, page, count, clubId);
