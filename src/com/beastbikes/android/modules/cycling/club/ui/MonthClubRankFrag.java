...
public class MonthClubRankFrag extends SessionFragment implements PullRefreshListView.onListViewListener {
        ...
        this.getAsyncTaskQueue().add(
                new AsyncTask<Void, Void, List<ClubRankBean>>() {
                    ...
                    protected List<ClubRankBean> doInBackground(Void... params) {
                        try {
                            return clubManager
                                    .getClubRankList(ClubManager.CLUB_RANK_MONTH, page, count);
