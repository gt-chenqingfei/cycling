package com.beastbikes.android.modules.cycling.club.ui.widget.painter.progress;
 ...
 */
public class ProgressTextPainterImp implements ProgressTextPainter {
    ...
    public ProgressTextPainterImp(int color, float max, int margin, Context context) {
        this.color = color;
        this.max = max;
