...
public class MonthlyRankFragment extends SessionFragment implements SwipeRefreshLoadRecyclerView.RecyclerCallBack,
    ...
    private int type = RankingManager.RANK_MONTHLY;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        RankRecyclerViewAdapter rankRecyclerViewAdapter = new RankRecyclerViewAdapter(this.getActivity(), this);
