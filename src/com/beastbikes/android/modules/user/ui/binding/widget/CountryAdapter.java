...
//		}
	...
	public View getTitleView(int group, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			ll.setBackgroundColor(parent.getContext().getResources().getColor(R.color.bg_border_line_color));
			convertView = ll;

			TextView tv = new TextView(parent.getContext());
			tv.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 11);
			tv.setTextColor(parent.getContext().getResources().getColor(R.color.smssdk_white));
			...
			vDiv.setBackgroundColor(parent.getContext().getResources().getColor(R.color.bg_border_line_color));
	...
	public View getView(int group, int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			LinearLayout ll = new LinearLayout(parent.getContext());
			ll.setBackgroundColor(parent.getContext().getResources().getColor(R.color.common_bg_color));
			convertView = ll;
