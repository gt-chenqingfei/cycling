...
import com.beastbikes.android.modules.user.filter.filter.IF1977Filter;
import com.beastbikes.android.modules.user.filter.filter.IFAmaroFilter;
import com.beastbikes.android.modules.user.filter.filter.IFBrannanFilter;
import com.beastbikes.android.modules.user.filter.filter.IFEarlybirdFilter;
import com.beastbikes.android.modules.user.filter.filter.IFHefeFilter;
import com.beastbikes.android.modules.user.filter.filter.IFHudsonFilter;
import com.beastbikes.android.modules.user.filter.filter.IFInkwellFilter;
import com.beastbikes.android.modules.user.filter.filter.IFLomoFilter;
import com.beastbikes.android.modules.user.filter.filter.IFLordKelvinFilter;
import com.beastbikes.android.modules.user.filter.filter.IFNashvilleFilter;
import com.beastbikes.android.modules.user.filter.filter.IFRiseFilter;
import com.beastbikes.android.modules.user.filter.filter.IFSierraFilter;
import com.beastbikes.android.modules.user.filter.filter.IFSutroFilter;
import com.beastbikes.android.modules.user.filter.filter.IFToasterFilter;
import com.beastbikes.android.modules.user.filter.filter.IFValenciaFilter;
import com.beastbikes.android.modules.user.filter.filter.IFWaldenFilter;
import com.beastbikes.android.modules.user.filter.filter.IFXprollFilter;

public class FilterTools {
    private static final byte FILTER_COUNT = 5;

//	public static List<FilterItem> getFilterItemLists() {
//		List<FilterItem> filters = new ArrayList<FilterItem>();
//		filters.add(new FilterItem("原图", FilterType.NO_FILTER,
//				new ColorDrawable(Color.RED)));
//		filters.add(new FilterItem("1977", FilterType.I_1977,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("阿马罗", FilterType.I_AMARO,
//				new ColorDrawable(Color.BLUE)));
//		filters.add(new FilterItem("布兰南", FilterType.I_BRANNAN,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("晨鸟", FilterType.I_EARLYBIRD,
//				new ColorDrawable(Color.BLUE)));
//		filters.add(new FilterItem("Hefe", FilterType.I_HEFE,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("Hudson", FilterType.I_HUDSON,
//				new ColorDrawable(Color.BLUE)));
//		filters.add(new FilterItem("Inkwell", FilterType.I_INKWELL,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("LordKelvin", FilterType.I_LORDKELVIN,
//				new ColorDrawable(Color.BLUE)));
//		filters.add(new FilterItem("Nashville", FilterType.I_NASHVILLE,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("Sutro", FilterType.I_SUTRO,
//				new ColorDrawable(Color.BLUE)));
//		filters.add(new FilterItem("Toaster", FilterType.I_TOASTER,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("Valencia", FilterType.I_VALENCIA,
//				new ColorDrawable(Color.BLUE)));
//		filters.add(new FilterItem("Walden", FilterType.I_WALDEN,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("Xproll", FilterType.I_XPROII,
//				new ColorDrawable(Color.BLUE)));
//		filters.add(new FilterItem("Contrast", FilterType.CONTRAST,
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("Lomo", FilterType.I_LOMO,
//				new ColorDrawable(Color.BLUE)));
...
//				new ColorDrawable(Color.GRAY)));
//		filters.add(new FilterItem("Lookup Amatorka",
//				FilterType.LOOKUP_AMATORKA, new ColorDrawable(Color.BLUE)));
//
//		return filters;
//	}

//	public static List<FilterItem> getFilterItemList() {
//		List<FilterItem> filters = new ArrayList<FilterItem>();
//		filters.add(new FilterItem("原图", FilterType.NO_FILTER));
//		filters.add(new FilterItem("1977", FilterType.I_1977));
//		filters.add(new FilterItem("阿马罗", FilterType.I_AMARO));
...
//	}
//	
//	public static List<FilterType> getFilterTypeList() {
//		List<FilterType> filters = new ArrayList<FilterType>();
//		filters.add(FilterType.NO_FILTER);
//		filters.add(FilterType.I_1977);
//		filters.add(FilterType.I_AMARO);
//		filters.add(FilterType.I_BRANNAN);
//		filters.add(FilterType.I_EARLYBIRD);
//		filters.add(FilterType.I_HEFE);
//		filters.add(FilterType.I_HUDSON);
//		filters.add(FilterType.I_INKWELL);
//		filters.add(FilterType.I_LORDKELVIN);
//		filters.add(FilterType.I_NASHVILLE);
//		filters.add(FilterType.I_SUTRO);
//		filters.add(FilterType.I_TOASTER);
//		filters.add(FilterType.I_VALENCIA);
//		filters.add(FilterType.I_WALDEN);
//		filters.add(FilterType.I_XPROII);
//		filters.add(FilterType.CONTRAST);
//		filters.add(FilterType.I_LOMO);
//		filters.add(FilterType.SEPIA);
//		filters.add(FilterType.VIGNETTE);
//		filters.add(FilterType.TONE_CURVE);
//		filters.add(FilterType.LOOKUP_AMATORKA);
//		return filters;
//	}

    public static List<FilterType> getFilterTypeList1() {
        List<FilterType> filters = new ArrayList<FilterType>(FILTER_COUNT);
        filters.add(FilterType.I_AMARO);
        filters.add(FilterType.I_HUDSON);
        filters.add(FilterType.I_VALENCIA);
        filters.add(FilterType.I_XPROII);
    ...
    public static List<FilterType> getFilterTypeList2() {
        List<FilterType> filters = new ArrayList<FilterType>(FILTER_COUNT);
        filters.add(FilterType.I_LOMO);
        filters.add(FilterType.I_BRANNAN);
        filters.add(FilterType.I_INKWELL);
    ...
    public static List<FilterType> getFilterTypeList3() {
        List<FilterType> filters = new ArrayList<FilterType>(FILTER_COUNT);
        filters.add(FilterType.TONE_CURVE);
        filters.add(FilterType.VIGNETTE);
        filters.add(FilterType.I_SUTRO);
    ...
    public static List<FilterType> getFilterTypeList4() {
        List<FilterType> filters = new ArrayList<FilterType>(FILTER_COUNT);
        filters.add(FilterType.I_1977);
        filters.add(FilterType.I_LORDKELVIN);
        filters.add(FilterType.CONTRAST);
    ...
    public static GPUImageFilter createFilterForType(final Context context,
        ...
        switch (type) {
            case NO_FILTER:
                return new GPUImageFilter(GPUImageFilter.NO_FILTER_VERTEX_SHADER,
