...
//            executePermissionsRequest(object, perms, requestCode);
            ...
            Collections.addAll(permList, perms);
            checkDeniedPermissionsNeverAskAgain(object, rationale, R.string.activity_alert_dialog_text_ok,
                    R.string.activity_alert_dialog_text_cancel, permList);
        }
    }
