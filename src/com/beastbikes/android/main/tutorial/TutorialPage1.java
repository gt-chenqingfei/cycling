...
public class TutorialPage1 extends TutorialPage {
    ...
    public TutorialPage1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TutorialPage1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        final View page = inflate(context, R.layout.tutorial_page1, null);
        this.addView(page);
    }
